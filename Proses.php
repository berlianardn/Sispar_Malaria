...
if(isset($_POST['submit'])){
    $qry='select id from tb_aturan where ';
    array_pop($_POST);
    $rule_input=array();
    ...
    $rule=array(
        ...
        array("G001","G002","G004","G005","G013","G014","G016","G019","G020"),
        array("G001","G002","G005","G006","G007","G008","G009","G011","G012","G013",
        "G014","G015","G017","G018","G020"),
